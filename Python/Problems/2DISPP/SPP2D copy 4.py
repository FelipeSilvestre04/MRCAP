...
def dimensions(dataset: str): 
    ...
    specs = {
        ...
        'dighe1':      (102.14,   100.0,    1, [0]),
        'dighe2':      (134.05,   100.0,    1, [0]),
        'albano':      (10122.63, 4900.0,   1, [0,2]),
        'dagli':       (60.6,     60.0,     1, [0,2]),
        'mao':         (1858.6,   2550.0,   1, [0,1,2,3]),
        'marques':     (80.6,     104.0,    1, [0,1,2,3]),
...
if __name__ == '__main__':
    ...
    instancias = ["mao",'fu',"shapes2","marques","jackobs1","jackobs2","dagli", "albano", "swim","shapes0","shapes1","trousers","shirts"] 
